function [ PyIsGood, cmdout ] = runPythonsetupall( trial, folder )
% cf=pwd
fno=num2str(folder);
path=['jw/' trial fno];
cd(['./' path])
...
%         end
        try
            if contains(trials(i).name, 'initial')~=1
                ...
                f1=fullfile([parentFolder filesep 'RESULTS_IMP2' filesep  name filesep],'target_AP.inp');
                f2=fullfile([parentFolder filesep 'RESULTS_IMP2' filesep  name filesep],'target_IE.inp');
...
%                 end
	...
	f9=fullfile([parentFolder filesep 'RESULTS_IMP1' filesep  name filesep],'target_AP.inp');
                f10=fullfile([parentFolder filesep 'RESULTS_IMP1' filesep  name filesep],'target_IE.inp');
f11=fullfile([parentFolder filesep 'RESULTS_IMP1' filesep  name filesep],'target_AP.inp');
                f12=fullfile([parentFolder filesep 'RESULTS_IMP1' filesep  name filesep],'target_IE.inp');
